...
复刻与后续扩展的参考规格见 [RECREATE_PROMPT.md](RECREATE_PROMPT.md)，保留所提供文件的正文。

**版本说明**：这份参考文档描述的是“十波生存战”扩展版本，包含八类武器、防具、掉落等要求；当前仓库与在线成品仍是下述单关卡、8 名敌人的 Demo。收录该文档不表示其中全部扩展功能已经实现，实际玩法以本 README 和当前源码为准。
